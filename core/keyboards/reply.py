...
input_field_placeholder='Отрпавить локацию, номер телефона или создай викторину/опрос ↓')


def get_reply_keyboard():
    keyboard_builder = ReplyKeyboardBuilder()

    keyboard_builder.button(text='Конпка 1')
    keyboard_builder.button(text='Конпка 2')
    keyboard_builder.button(text='Конпка 3')
